...
import com.ecomapp.ecomapp.service.UserNotFoundException;
...
public class ForgotPasswordController {
    ...
    private UserService userService;
        ...
        public String showForgotPasswordForm() {
            return "/otp/forgot_password_form";
        }
    ...
    public String processForgotPassword(HttpServletRequest request, Model model) {
        ...
        System.out.println(email+"my email---------------------------");
        try {
    ...
    public void sendEmail(String recipientEmail, String link)
        ...
        helper.setFrom("sukanyarajendran3@gmail.com", "Tedx Watch Support");
    ...
    public String showResetPasswordForm(@Param(value = "token") String token, Model model) {
        ...
        return "/Otp/reset_password_form";
    }
